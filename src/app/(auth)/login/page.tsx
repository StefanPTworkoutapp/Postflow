    ...
    <Card>
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="text-xs text-[hsl(var(--muted-foreground))] underline-offset-4 hover:underline"
              >
                Forgot password?
              </Link>
            </div>
      ...
      <CardFooter className="justify-center">
        <p className="text-sm text-[hsl(var(--muted-foreground))]">
          No account yet?{" "}
          <Link href="/signup" className="font-medium text-[hsl(var(--foreground))] underline-offset-4 hover:underline">
            Sign up
          </Link>
        </p>
      </CardFooter>
