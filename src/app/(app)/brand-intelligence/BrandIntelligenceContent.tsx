 ...
 *
 * Async server component that renders the full brand intelligence dashboard
 * for a given brandId. Extracted from brand-intelligence/page.tsx so it can
 * be embedded in the /brand page under the "Intelligence" tab without
...
export function BrandIntelligenceContent({
  ...
  const stuckTokens = tokenEntries.filter(([key, t]) => {
    if (t.confidence >= 0.25) return false
